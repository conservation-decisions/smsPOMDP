...
minigraph = function(tab, tab2=NULL, size = 1){
  if(is.null(tab2)){
    ...
    if (n ==3){
      ...
      t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im3.jpg",sep=""))
      ...
      a1 = switch (as.numeric(as.character(tab[1,1])), 'MANAGE','SURVEY','NOTHING')
      a2 = switch (as.numeric(as.character(tab[2,1])), 'MANAGE','SURVEY','NOTHING')
      t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im2.jpg",sep=""))
      graphics::plot(t, axes = F)
      ...
      a1 = switch (as.numeric(as.character(tab[1,1])),'MANAGE','SURVEY','NOTHING')
      t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im1.jpg",sep=""))
      graphics::plot(t, axes = F)
    ...
    if (n2==3){
      ...
      t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im3_3.jpg",sep=""))
      graphics::plot(t, axes = F)
      #text for solution if starting from c(1,0)
      ...
      if (n == 3){
        ...
        t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im3_2.jpg",sep=""))
        graphics::plot(t, axes = F)
        #text for solution if starting from c(1,0)
        graphics::text(740,300,'Not seen for', cex = size)
        graphics::text(740, 350, y1, cex = size)
        ...
        t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im2_2.jpg",sep=""))
        graphics::plot(t, axes = F)
        #text for solution if starting from c(1,0)
      ...
      if (n == 3){
        ...
        t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im3_1.jpg",sep=""))
        graphics::plot(t, axes = F)
        #text for solution if starting from c(1,0)
        graphics::text(740,300,'Not seen for', cex = size)
        graphics::text(740, 350, y1, cex = size)
        ...
        t = imager::load.image(file=paste(path.package("smsPOMDP"),"/inst/exdata/im2_1.jpg",sep=""))
        graphics::plot(t, axes = F)
        #text for solution if starting from c(1,0)
        graphics::text(750,300,'Not seen for', cex = size)
        graphics::text(740, 350, y1, cex = size)
