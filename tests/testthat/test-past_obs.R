...
test_that("check,past_obs()", {
  ...
  values <- smsPOMDP::past_obs(input)
  testthat::expect_equal(values[1], 'Not_seen')
  testthat::expect_equal(values[2], 'Not_seen')
  testthat::expect_equal(values[3], 'Seen')
